...
namespace DragonWater
{
    ...
    public class MaterialProfile : ScriptableObject
    {
        ...
        public void ConfigureMaterial(Material material, bool force = false)
        {
            ...
            material.SetFloat(Constants.Shader.Property.WaterDepth, 1.0f / waterDepth);
            ...
            else if (transparencyType == TransparencyType.Refraction)
            {
                ...
                material.SetVector(Constants.Shader.Property.RefractionParams, new Vector4(refractionStrength, 1.0f / refractionDistanceFactor, 0, 0));
            }
