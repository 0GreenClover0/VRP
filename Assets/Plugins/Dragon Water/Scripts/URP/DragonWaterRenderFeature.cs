...
namespace DragonWater.URP
{
    public class DragonWaterRenderFeature : ScriptableRendererFeature
    {
        ...
        public override void Create()
        {
            ...
            var useRenderGraph = !GraphicsSettings.GetRenderPipelineSettings<RenderGraphSettings>().enableRenderCompatibilityMode;
#endif
            ...
            if (useRenderGraph)
            {
                _waterSurfacePass.renderPassEvent = RenderPassEvent.BeforeRenderingTransparents + 1;
                _reCopyDepthPass.renderPassEvent = RenderPassEvent.BeforeRenderingTransparents + 2;
                _reCopyColorPass.renderPassEvent = RenderPassEvent.BeforeRenderingTransparents + 2;
            }
            else
            {
#endif
