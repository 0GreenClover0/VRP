...
namespace DragonWater
{
    internal static class Constants
    {
        ...
        public static readonly int MaxRippleCasters = 32;
        ...
        public static class Shader
        {
            ...
            public const string BlitShaderName = "Hidden/Dragon Water Blit";
            ...
            public static class Keyword
            {
                ...
                // compute enum
                public const string ComputePrecisionHigh = "_PRECISION_HIGH";
                public const string ComputePrecisionSimple = "_PRECISION_SIMPLE";
                public const string ComputePrecisionFlat = "_PRECISION_FLAT";
                public static readonly string[] ComputePrecision = new[] { ComputePrecisionHigh, ComputePrecisionSimple, ComputePrecisionFlat };
            }
            public static class Property
            {
                ...
                public static readonly string WaterCutoutMaskName = "_Water_Cutout_Mask";
                public static readonly int WaterCutoutMask = UnityEngine.Shader.PropertyToID(WaterCutoutMaskName);
                ...
                public static readonly int ComputeTextureSizeInv = UnityEngine.Shader.PropertyToID("TextureSizeInv");
                public static readonly int ComputeProjectionSize = UnityEngine.Shader.PropertyToID("ProjectionSize");
                public static readonly int ComputeProjectionSizeInv = UnityEngine.Shader.PropertyToID("ProjectionSizeInv");
                ...
                public static readonly int ComputeWaveTextureSize = UnityEngine.Shader.PropertyToID("WaveTextureSize");
                public static readonly int ComputeWaveProjectionSize = UnityEngine.Shader.PropertyToID("WaveProjectionSize");
                public static readonly int ComputeWaveProjectionSizeInv = UnityEngine.Shader.PropertyToID("WaveProjectionSizeInv");
